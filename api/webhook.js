...
<div style="max-width:520px;margin:0 auto;background:#fff;border:1px solid #ded6cf;">
  ...
  <div style="padding:32px 40px;">
    ...
    <div style="border-left:2px solid #b85c38;padding-left:16px;margin-bottom:28px;">
      ...
      <p style="font-size:12px;color:#918b84;margin:0;line-height:1.75;">Verpak het kledingstuk in een plastic zakje tegen vocht, daarna in een doos of stevige envelop. Voeg een briefje toe met je referentiecode. Verstuur via PostNL, DHL of een andere aanbieder — bewaar je bon, de verzendkosten worden vergoed.</p>
    </div>
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.log("Customer email sent to", meta.customer_email);
  } catch (err) {
